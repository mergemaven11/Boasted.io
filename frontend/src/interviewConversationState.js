...
const ALLOWED_TRANSITIONS = Object.freeze({
  [INTERVIEW_PHASES.IDLE]: new Set([INTERVIEW_PHASES.GREETING, INTERVIEW_PHASES.ASKING, INTERVIEW_PHASES.SPEAKING]),
  [INTERVIEW_PHASES.GREETING]: new Set([INTERVIEW_PHASES.GREETING, INTERVIEW_PHASES.ASKING, INTERVIEW_PHASES.SPEAKING, INTERVIEW_PHASES.IDLE]),
  [INTERVIEW_PHASES.ASKING]: new Set([INTERVIEW_PHASES.ASKING, INTERVIEW_PHASES.SPEAKING, INTERVIEW_PHASES.LISTENING, INTERVIEW_PHASES.IDLE]),
  [INTERVIEW_PHASES.SPEAKING]: new Set([INTERVIEW_PHASES.SPEAKING, INTERVIEW_PHASES.ASKING, INTERVIEW_PHASES.LISTENING, INTERVIEW_PHASES.REVIEWING, INTERVIEW_PHASES.TRANSITION, INTERVIEW_PHASES.IDLE]),
  [INTERVIEW_PHASES.LISTENING]: new Set([INTERVIEW_PHASES.LISTENING, INTERVIEW_PHASES.ASKING, INTERVIEW_PHASES.SPEAKING, INTERVIEW_PHASES.REVIEWING, INTERVIEW_PHASES.IDLE]),
  [INTERVIEW_PHASES.REVIEWING]: new Set([INTERVIEW_PHASES.REVIEWING, INTERVIEW_PHASES.SPEAKING, INTERVIEW_PHASES.TRANSITION, INTERVIEW_PHASES.IDLE]),
  [INTERVIEW_PHASES.TRANSITION]: new Set([INTERVIEW_PHASES.TRANSITION, INTERVIEW_PHASES.ASKING, INTERVIEW_PHASES.SPEAKING, INTERVIEW_PHASES.IDLE]),
});
...
export function avatarStateForInterviewPhase(phase) {
  ...
  if (phase === INTERVIEW_PHASES.SPEAKING) return "speaking";
