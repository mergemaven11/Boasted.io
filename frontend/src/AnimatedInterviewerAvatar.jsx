    ...
    <div className={`animated-interviewer-avatar state-${safeState} ${reducedMotion ? "reduced-motion" : ""}`} role="img" aria-label={`${name}, virtual interviewer, ${STATE_COPY[safeState]}`}>
      ...
      <svg className="interviewer-person" viewBox="0 0 420 520" aria-hidden="true">
        ...
        <g filter="url(#avatarShadow)" className="avatar-body">
          ...
          <g className="avatar-brows" fill="none" stroke="#2a1714" strokeWidth="8" strokeLinecap="round">
            <path d="M153 195q29-17 51-2"/><path d="M226 193q25-15 47 1"/>
          </g>
          <g className="avatar-eyes">
            <ellipse cx="178" cy="215" rx="20" ry="10" fill="#fff5eb"/><ellipse cx="248" cy="214" rx="20" ry="10" fill="#fff5eb"/>
            <circle cx="179" cy="215" r="7.5" fill="#251816"/><circle cx="248" cy="214" r="7.5" fill="#251816"/>
            <circle cx="181" cy="212" r="2.3" fill="#fff"/><circle cx="250" cy="211" r="2.3" fill="#fff"/>
          </g>
          ...
          <g className="avatar-mouth">
            <path className="mouth-closed" d="M179 279q34 23 69 0-35 11-69 0z" fill="#8d2e3d"/>
            <path className="mouth-open" d="M180 278q34 29 69 0-4 36-35 36-29 0-34-36z" fill="#5b1723"/>
            <path className="mouth-smile" d="M177 276q37 31 75 0-11 39-39 39-27 0-36-39z" fill="#8d2e3d"/>
            <path className="teeth" d="M187 282q27 14 54 0-23 16-54 0z" fill="#fff8f1"/>
          </g>
          ...
          <path d="M199 323q12 10 25 0" fill="none" stroke="#d7aa62" strokeWidth="3"/>
          <circle cx="212" cy="354" r="5" fill="#d7aa62"/><path d="M212 354v23" stroke="#d7aa62" strokeWidth="2"/>
        </g>
      </svg>
...
AnimatedInterviewerAvatar.propTypes = {
  state: PropTypes.oneOf(["idle", "speaking", "listening", "thinking", "encouraging"]),
