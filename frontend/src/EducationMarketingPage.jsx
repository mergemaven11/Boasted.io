...
const stages = [
  { title: "Middle school", status: "coming-soon", text: "The younger-student experience is under construction and is not open yet while BragStack completes youth privacy, consent, safety, and legal review." },
  { title: "High school", status: "available", text: "High-school students who are already 18 can track current activities, leadership, awards, projects, service, jobs, competitions, and the stories behind them." },
  { title: "College / University", status: "available", text: "Adult students can track research, internships, campus leadership, projects, certifications, work, service, and the skills they are building." },
...
export default function EducationMarketingPage() {
  useEffect(() => {
    ...
    meta.setAttribute("content", "BragStack Education is currently available to adults 18+ for capturing real education, project, service, work, and learning accomplishments. High-school students who are already 18 can use the live Education workspace; younger-student access is coming later.");
  }, []);
  ...
  return <main className="education-marketing">
    ...
    <section className="education-public-age-alert" role="status">
      ...
      <div><LockKeyhole size={19}/><p><strong>BragStack Education currently supports adults age 18 and older.</strong><span>That includes high-school students who are already 18 and adult college/university students. Middle-school and other under-18 student access is not currently available.</span></p></div>
    </section>
    ...
    <section className="education-hero">
      <div>
        ...
        <p className="education-note"><LockKeyhole size={15}/> Accounts are currently limited to people age 18+. High-school students who are already 18 can use Education now.</p>
      ...
      <aside className="education-story-card">
        ...
        <div className="education-story-line"><b>High school</b><small>Available now for students who are 18+</small><i/></div>
        <div className="education-story-line"><b>College / University</b><small>Available now for adults 18+</small><i/></div>
