  ...
  return (
    <aside className="analytics-consent" aria-label="Analytics privacy choices">
      <div>
        ...
        <p>
          BragStack uses essential browser storage for sign-in and core features. With your permission,
          we also use Google Analytics to understand product usage and campaign performance. Analytics
          stays off unless you choose Allow analytics. See the <a href="/privacy">Privacy Policy</a>.
        </p>
      </div>
