    ...
    <main className="landing-page landing-page-simple">
      ...
      <section className="landing-workflow premium-workflow landing-simple-workflow" id="how-it-works">
        ...
        <div className="landing-simple-receipt-note">
          <Sparkles size={20} />
          <div><strong>Impact Receipts are the proof version of an important win.</strong><span>They keep what you did, what happened, the evidence, skills, and credit together so you can reuse the story without exaggerating it.</span></div>
        </div>
      </section>
      ...
      <section className="landing-feature-section landing-simple-trust" id="security">
        ...
        <div className="feature-dashboard-preview landing-simple-trust-card">
          ...
          <div className="feature-preview-entry">
            <div><span className="feature-preview-badge">Simple rule</span><small>You stay in control</small></div>
            <h3>Save the useful part. Leave secrets out.</h3>
            <p>Keep the result, skill, lesson, and credit you are allowed to keep. Do not upload employer secrets, customer secrets, or anything your agreements say you cannot store.</p>
          </div>
        </div>
      </section>
      ...
      <section className="landing-pricing" id="pricing">
        <div className="landing-section-heading">
          <p>PRICING</p>
          <h2>Everyone gets Pro for now.</h2>
          <span>Boasted Pro is temporarily complimentary during early access. No payment method is required.</span>
        </div>
      ...
      <footer className="mega-footer landing-simple-footer">
        ...
        <div className="mega-footer-columns landing-simple-footer-columns">
          ...
          <div><h3>Company</h3><a href="mailto:hello@boasted.io">Contact</a><a href="mailto:hello@boasted.io?subject=Boasted%20Team%20waitlist">Team waitlist</a><a href="mailto:hello@boasted.io?subject=Boasted%20Enterprise">Enterprise</a></div>
        </div>
