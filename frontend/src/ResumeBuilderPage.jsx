...
export default function ResumeBuilderPage() {
  ...
  async function handleBuild(event) {
    ...
    setMessage("");
    try {
      const data = await buildResume({ target_role: targetRole, job_description: jobDescription, selected_receipt_ids: selectedIds });
      setResult(data);
  ...
  async function handleSave() {
    ...
    const created = await saveResume({ title, target_role: targetRole, job_description: jobDescription, summary, bullets, skills: result.skills || [] });
  ...
  return (
    <main className="resume-builder-page">
      <header className="resume-builder-hero">
        <div><span className="resume-pro-badge"><Sparkles size={14} /> BRAGSTACK PRO</span><h1>Resume Builder</h1><p>Build an ATS-friendly resume draft from career proof—not invented claims.</p></div>
