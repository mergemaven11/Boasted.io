...
const protections = [
  ...
  { icon: KeyRound, title: "Protected sign-in", text: "Boasted supports account authentication and sign-in providers such as Google and GitHub. Protect the account you use to sign in and sign out on shared devices." },
  { icon: ShieldCheck, title: "Secure connections", text: "Production traffic uses encrypted HTTPS connections. Boasted also uses access controls and hosted infrastructure intended to reduce unauthorized access to application data." },
  { icon: CreditCard, title: "Payments handled by Stripe", text: "Subscription checkout is handled by Stripe. Boasted uses billing status and account entitlement information to unlock paid features rather than storing full payment-card numbers itself." },
];
  ...
  return (
    <main className="security-page">
      <header className="security-topbar">
        <a className="security-brand" href="/"><img src="/brandmark.svg" alt="" /><strong>Boasted</strong></a>
      ...
      <section className="security-hero">
        <div className="security-hero-copy">
          <span className="security-kicker"><ShieldCheck size={16} /> BOASTED SECURITY</span>
          <h1>Your career proof deserves careful protection.</h1>
          <p>Boasted is designed around a simple idea: your private career evidence should stay private unless you decide otherwise. This page explains our security approach in plain English for people across professions and work settings.</p>
          <div className="security-actions"><a className="security-primary" href="/docs#privacy">Read privacy & NDA guidance</a><a className="security-secondary" href="mailto:security@boasted.io?subject=Boasted%20security%20report">Report a security concern</a></div>
        </div>
      ...
      <section className="security-grid" aria-label="Boasted security protections">
