  ...
  return (
    <section className={`packet-sheet packet-document-page packet-reviewer-page ${themeClass(packet)}`}>
      ...
      <p className="packet-reviewer-intro">
        Use this page to assess the packet, flag factual corrections, and leave actionable feedback. Ratings are completed by the reviewer—not generated by Boasted.
      </p>
      ...
      <aside className="packet-reviewer-safety-note">
        ...
        <p>Reviewer notes do not overwrite accomplishments, Impact Receipts, evidence, or recognition in Boasted. The packet owner decides what source records should be updated.</p>
      </aside>

      <footer className="packet-page-footer"><span>Boasted · Reviewer Worksheet</span><span>Page {page}</span></footer>
    </section>
  );
}
