...
def normalize_slug(slug): return slug.strip().lower()
...
def get_public_profile_by_slug(slug:str): return {"profile":serialize_public_profile(get_user_by_public_slug(slug))}
