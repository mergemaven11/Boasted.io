...
def _load_intelligence(current_user: dict) -> dict:
    ...
    return enforce_intelligence_result(result, violations=violations,
        ...
        failure_message="Boasted withheld Career Intelligence because its calculated metrics did not reconcile to your saved proof.",
...
def _load_application_intelligence(current_user: dict, application_type: str) -> dict:
    ...
    return enforce_intelligence_result(result, violations=violations,
        ...
        failure_message="Boasted withheld application guidance because its recommendations did not reconcile to your saved proof.",
        provider="deterministic",
...
def _load_major_explorer(current_user: dict) -> dict:
    ...
    return enforce_intelligence_result(result, violations=violations,
        ...
        failure_message="Boasted withheld Major Explorer guidance because the result did not satisfy its exploration and safety rules.",
        provider="deterministic",
