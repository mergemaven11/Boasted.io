...
def build_career_intelligence(
    ...
    *,
    ...
    This intentionally does not predict hiring or promotion outcomes. Every signal
    is derived from counts that can be traced back to accomplishments and Impact
    Receipts.
    """
    ...
    skills = []
    for key, state in skill_state.items():
        display = max(
        ...
        # These points are not an employment score; they summarize visible proof
        # dimensions and are returned with their components for full traceability.
