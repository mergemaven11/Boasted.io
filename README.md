...
The public `/privacy` route is the customer-facing source of truth for analytics and privacy-controlled diagnostics. Engineering configuration belongs in [`docs/posthog-production.md`](docs/posthog-production.md).
